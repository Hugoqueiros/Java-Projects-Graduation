...
function add_event(){
    ...
    $add_event_candidate_id = $_POST['add_event_candidate_id'];
    $query = "INSERT INTO events (event_title, event_description, event_date_ini, event_date_exp, event_candidate_id)
        VALUES ('$add_event_title', '$add_event_description', '$add_event_date_ini', '$add_event_date_exp', '$add_event_candidate_id')";
    $result = mysqli_query($connection, $query);
