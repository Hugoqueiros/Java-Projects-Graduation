    ...
    <body>
        ...
        if (!$_SESSION['admin_name']) {
            ...
            <div id="eventos">
                ...
                <div id="div_add_event_candidate_id">
                    <label>Inserir Candidatos: </label>
                    <input id="add_event_candidate_id">
                    <span class="helper-error" id="helper-error-add-event-candidate-id"></span>
                </div>
                <br>
